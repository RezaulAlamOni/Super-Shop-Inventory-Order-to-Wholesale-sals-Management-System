...
<div class="main-content-container container-fluid px-4">
  ...
  <div class="well" style="border: 3px solid #428bca;">
					<div class="header col-md-12 col-xs-12" style="font-size: 18px; padding: 10px;">
						<span class="pull-left">店舗発注</span>
					...
					<div class="form-horizontal" id="handy_order_form">
						...
						<div class="form-group">
							<div class="col-md-4 col-xs-12 scan_btn">
								<input style="color: #000; font-size: 20px; height: 45px;" type="tel" data_field_name="get_handy_customer_master_jan" class="form-control scanner"  id="customer_master_jancode" placeholder="JANコード（13桁）">
...
<input type="hidden" data_page="janmaster_handy" data_br_sp_id="" id="get_janCode" value="" name="get_janCode">
						...
						<div class="form-group">
							<div class="col-md-4 col-xs-12 padding_0">
								<input style="color: #000; font-size: 20px; height: 40px;" data_field_name="reck_no" type="number" class="form-control scanner" id="reck_code" maxlength="4" placeholder="">
							</div>							
						</div>
