...
<div class="main-content-container container-fluid px-4">
  ...
  <div class="well" style="border: 3px solid #428bca;">
					<div class="header col-md-12 col-xs-12" style="font-size: 18px; padding: 10px;">
						...
						<a href="{{Config::get('app.url').'/inventoryentrybyhandy'}}" class="btn btn-success pull-right" style="float:right"> 棚卸棚番スキャン</a>
					</div>
					<div class="form-horizontal" id="handy_order_form">
						...
						<div class="form-group">
							<div class="col-md-4 col-xs-12 scan_btn">
								<input style="color: #000; font-size: 20px; height: 45px;" type="tel" data_field_name="get_stock_detail_by_jan" class="form-control scanner" id="vendor_master_jancode" placeholder="JANコード（13桁）">
