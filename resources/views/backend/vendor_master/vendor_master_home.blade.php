...
@section('content')
    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-md-3">
                <h2><input type="text" readonly value="" class="supplier_name_input" name="">&nbsp;&nbsp;&nbsp;殿
                    <div
...
<img src="{{Config::get('app.url').'/public/backend/images/voice_rec.gif'}}" class="voice_recoring">
            ...
            <!-- <a class="btn btn-primary  btn-lg pull-right" href="{{Config::get('app.url').'/customer_master'}}">販売先マスター</a> -->
                <!-- <button class="btn btn-primary show_tonya_list_for_haccu  btn-lg pull-right">仕入先名別発注リスト</button> -->
                <a href="javascript:void(0)" class="btn btn-info btn-lg pull-right mb-1" onclick="get_vendor_master_item_list_order('tonoya')">問屋 毎</a>
                <a href="javascript:void(0)" class="btn btn-info btn-lg pull-right mb-1" onclick="get_vendor_master_item_list_order('maker')">メーカー 毎</a>
                <a href="javascript:void(0)" class="btn btn-info btn-lg pull-right mb-1" onclick="get_vendor_master_item_list_order('num_of_order')">注文数</a>
                <a href="{{ route('hacchu.order.list') }}" class="btn btn-success btn-lg pull-right mb-1">仕入先名別発注リスト</a>
                <button class="btn btn-danger deletes_vendor_item  btn-lg pull-right mb-1"
                        vendor_item_delete_enable="0">行削除
                </button>
                <a href="javascript:history.back();" class="btn btn-info  btn-lg pull-right mb-1">戻る</a>
                <a href="{{Config::get('app.url').'/home'}}"
                   class="btn btn-danger  btn-lg pull-right goto_homepages mb-1">業務選択</a>
            ...
            <div class="col-md-6 text-right">
                <div class="btn_right_are" style="display: none;">
                    <ul class="custom_brder_top_right">
                        <li>
                            <button type="button" class="btn dflt_jacos_btn">商 品</button>
                        </li>
                        <li>
                            <button type="button" data-tippy-content="商品の登録を行います。"
                                    class="btn btn-warning v_new_item_btn_top add_new_item pull-right">登録
                            </button>
                            <button type="button" data-tippy-content="商品の修正を行います。" vendor_item_edit_enable="0"
                                    class="btn btn-primary edits_vendor_item pull-right">修正
                            </button>
                            <button type="button" data-tippy-content="商品の削除を行います。" vendor_item_delete_enable="0"
                                    class="btn btn-danger deletes_vendor_item pull-right">削除
                            </button>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-md-12 estimate_product_table">
                <table class="table table-striped table-bordered product-table" id="product-table">
                    ...
                    <tr>
                        ...
                        <th nowrap style="text-align: center;" width="10%" class="tonya_name" data_c_type="1"
                            rowspan="2">
                            取引先名
                        </th>
                        <th nowrap style="text-align: center;padding:0;" class="filter_supplier_jan" data_c_type="1"
                            rowspan="2">
                            メーカー名＆ＪＡＮコード
                        </th>
                    </tr>
                  ...
                  <!--  <tr>
                        ...
                        <th></th>
                        <th></th>
                        <th style="padding:0;ime-mode: disabled;"><input style="border-radius:0;" name="serach_field12"
                                                                         id="serach_field12"
                                                                         class="form-control in_company_code_search vendor_item_search"
                                                                         type="tel" placeholder="自社コード（5桁"></th>
                        <th></th>
                        <th style="padding:0;ime-mode: disabled;"><input style="border-radius:0;" name="serach_field13"
                                                                         id="serach_field13"
                                                                         class="form-control jan_code_search vendor_item_search"
                                                                         type="tel" placeholder="JANコード（13桁）"></th>
                    </tr>-->
                    </thead>
