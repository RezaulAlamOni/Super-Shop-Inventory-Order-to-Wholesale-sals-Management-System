...
<body>
        ...
        <h3 style="font-family: MigMix 2p; text-align: center;">出荷伝票</h3>
        <br/>
    <table width="100%" style="text-align: center;">
        <tr>
            <td><p>納品先</p></td>
            <td><p class="box">{{$delivery_order_info[0]->customer_name}}</p></td>
            <td><p>納品日</p></td>
            <td><p class="box">{{date("Y-m-d", strtotime($delivery_order_info[0]->delivery_date))}}</p></td>
            <td><p>出荷番号</p></td>
            <td>
                <div class="">
                       <p style="margin-top: -10px;">
                        
                        <img src="data:image/png;base64, {{ base64_encode(QrCode::format('png')->size(100)->generate($delivery_order_info[0]->shipment_number)) }} ">
                    </p>
                       <p style="margin-top: -25px; margin-bottom: -10px; line-height: 10px;">{{$delivery_order_info[0]->shipment_number}}</p>
                </div>
            </td>
        </tr>
    </table>
