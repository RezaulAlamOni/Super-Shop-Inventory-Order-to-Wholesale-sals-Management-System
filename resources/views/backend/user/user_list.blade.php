					...
					?>
                        <tbody>
                            ...
                            <tr>
                                <td><?= $i; ?></td>
                                <td>{{$user->name}}
                                    <input type="hidden" name="" id="user_name{{$user->id}}" value="{{$user->name}} ">
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="{{Config::get('app.url').'user_update/'.$user->id}}"
                                        class="btn btn-info"><i class="fas fa-eye"></i> {{__('messages.view')}}</a>
                                    @endcan
                                    @can('retrieve_users')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input id="password-confirm" type="password" class="form-control"
                                name="password_confirmation" placeholder="{{__('messages.user_list_confirm_password')}}"
