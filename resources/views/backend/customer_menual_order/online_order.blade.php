...
<input type="tel" style="ime-mode: disabled;float:left;border:1px solid #ddd;" class="form-control jan_inpts jan_inpts_online_order" placeholder="ＪＡＮまたはインストア入力">
				</button>

				  <button type="button" class="btn btn-info"><a class="page_manage custom_online_order" style="color:#fff" href="manualOrder">手書</a></button>
