        ...
        <div class="page-header row no-gutters py-1">
            ...
            <div class="col-md-4 col-sm-4 mb-0">
                <div class="jcs_rcv_title divs_pages">
                    <span style="font-size:40px;color:#000;font-weight:bold;">買掛金 管理表 {{$tonyaInfo->name}}</span>
                    <?php
...
{{--                <span class="default_byr_syplr_mangentsht">円</span>--}}
            ...
            <div class="col-md-4 col-sm-4 mb-0">
                ...
                <ul class="top_page_btn_list_jacos list-inline text-right">
                    ...
                    <li><a href="{{Config::get('app.url').'/vendormangementsheet'}}" class="btn btn-success btn-lg gotomanagementsht">戻る</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div id="management_sheet_table_By_tonya" style="margin:0;">
                    <table class="table table-striped table-bordered shipment_sheet_table table-freeze-multi"
                        ...
                        <tr style="background: #eff5f1;">
                            ...
                            <th style="font-size: 24px;vertical-align:top !important;width: 320px">メモ</th>
                        </tr>
